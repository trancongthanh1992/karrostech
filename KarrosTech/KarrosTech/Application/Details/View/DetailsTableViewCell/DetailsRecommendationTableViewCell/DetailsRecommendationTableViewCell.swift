...
class DetailsRecommendationTableViewCell: UITableViewCell, NibReusable {

    let cellWidthConstant: CGFloat = 100
    let cellHeightConstant: CGFloat = 210
    ...
    lazy var collectionView: UICollectionView = { width, height in
        ...
        collectionView.register(cellType: DetailsRecommendationCollectionViewCell.self)
...
extension DetailsRecommendationTableViewCell {
    ...
    private func bindCollectionView(_ model: ObResultsRecommendationModel) {
        model
            ...
            .bind(to: collectionView.rx.items(
                    cellIdentifier: DetailsRecommendationCollectionViewCell.reuseIdentifier,
                    cellType: DetailsRecommendationCollectionViewCell.self))
