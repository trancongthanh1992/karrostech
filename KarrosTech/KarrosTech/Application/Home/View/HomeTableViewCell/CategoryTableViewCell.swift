...
class CategoryTableViewCell: UITableViewCell, NibReusable {
    ...
    let cellHeightConstant: CGFloat = 80
...
extension CategoryTableViewCell {
    ...
    private func bindCollectionView(_ model: ObResultCategoryModel) {
        ...
        model
            ...
            .filterNil()
            .bind(to: collectionView.rx.items(cellIdentifier: CategoryCollectionViewCell.reuseIdentifier, cellType: CategoryCollectionViewCell.self))
